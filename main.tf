                        ...
                        dynamic "headers" {
                          ...
                          content {
                            ...
                            dynamic "match_pattern" {
                              ...
                              content {
                                all              = lookup(match_pattern.key, "all", "{}") == "{}" && lookup(match_pattern.value, "included_headers") == null && lookup(match_pattern, "excluded_headers") == null ? "{}" : null
                                included_headers = lookup(match_pattern.value, "included_headers") == lookup(match_pattern.value, "included_headers") && lookup(match_pattern.key, "all", "{}") == null && lookup(match_pattern, "excluded_headers") == null ? lookup(match_pattern, "included_headers") : null
                                excluded_headers = lookup(match_pattern.value, "excluded_headers") == lookup(match_pattern.value, "excluded_headers") && lookup(match_pattern.key, "all", "{}") == null && lookup(match_pattern, "included_headers") == null ? lookup(match_pattern, "excluded_headers") : null
                              }
                            }
