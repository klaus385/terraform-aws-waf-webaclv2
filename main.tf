                          ...
                          content {
                            ...
                            dynamic "match_pattern" {
                              ...
                              content {
                                ...
                                included_headers = lower(lookup(match_pattern.value, "included_headers")) == lower(lookup(match_pattern.value, "included_headers")) && lower(lookup(match_pattern.value, "excluded_headers")) == null ? lower(lookup(match_pattern.value, "included_headers")) : null
